...
class FoodItemsControllerTest < ActionController::TestCase
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post :create, food_item: { food_family_id: @food_item.food_family_id, food_item: @food_item.food_item, picture: @food_item.picture }
    end
  ...
  test "should update food_item" do
    put :update, id: @food_item, food_item: { food_family_id: @food_item.food_family_id, food_item: @food_item.food_item, picture: @food_item.picture }
    assert_redirected_to food_item_path(assigns(:food_item))
  end
